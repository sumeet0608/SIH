...
function AssignRoles() {
    ...
    return (
        ...
        <div>
            ...
            <div className='login'>
            <form style={{paddingLeft : 60}} onSubmit={handlerSubmitRET}>
             ...
             <input className="form-control-sm" type="text" onChange={handlerChangeAddressRET} placeholder="Ethereum Address" required />
                ...
                <br></br>
                <button style={{marginLeft : 20}}className="btn btn-outline-success btn-sm"  onSubmit={handlerSubmitRET} >Register</button>
