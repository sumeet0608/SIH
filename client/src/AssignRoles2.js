...
function AssignRoles() {
    ...
    return (
        ...
        <div>
            ...
            <div className='login'>
            <form style={{paddingLeft : 60}} onSubmit={handlerSubmitDIS}>
             ...
             <input className="form-control-sm" type="text" onChange={handlerChangeAddressDIS} placeholder="Ethereum Address" required />
                ...
                <br></br>
                <button style={{marginLeft : 20}}className="btn btn-outline-success btn-sm"  onSubmit={handlerSubmitDIS} >Register</button>
