...
function Supply() {
    ...
    const handlerSubmitDistribute = async (event) => {
        event.preventDefault();
        try {
            var reciept = await SupplyChain.methods.Distribute(ID,Quantity).send({ from: currentaccount });
            if (reciept) {
                loadBlockchaindata();
            }
    ...
    return (
        <div>
            ...
            <li><a style={{textDecoration : 'none',color : 'white'}} href='/supply3'>SUPPLY</a></li>
            <li><a style={{textDecoration : 'none',color : 'white'}} href='/track3'>TRACK</a></li>
            <li><a style={{textDecoration : 'none',color : 'white'}} href='/roles2'>REGISTER</a></li>
            ...
            <form style={{paddingLeft : 60}} onSubmit={handlerSubmitDistribute}>
                <br></br><br></br>
             ...
             <input style={{marginLeft : 40,width:'20em',height:'3em'}} className="form-control-sm" type="text" onChange={handlerChangeQuantity} placeholder="Enter Quantity" required />
                <br></br>
                
            <button style={{marginLeft : 40,width:'10em',backgroundColor : 'whitesmoke',borderRadius : '2em',color:'black',fontSize : 'large'}} className="btn btn-outline-success btn-sm" onSubmit={handlerSubmitDistribute}>Supply</button>
