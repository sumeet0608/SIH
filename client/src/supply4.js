...
function Supply() {
    ...
    return (
        <div>
            ...
            <form style={{paddingLeft : 60}} onSubmit={handlerSubmitRetail}>
                <br></br><br></br>
            ...
            <button style={{marginLeft : 40,width:'10em',backgroundColor : 'whitesmoke',borderRadius : '2em',color:'black',fontSize : 'large'}} className="btn btn-outline-success btn-sm" onSubmit={handlerSubmitRetail}>Supply</button>
