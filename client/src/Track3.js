        ...
        <div style={{backgroundColor : '#b33415',height : 753}}>
            ...
            <thead>
                    <tr>
                        ...
                        <th scope="col">Name</th>
                        <th scope="col">Description</th>
                        <th scope="col">Manufacturing quantity</th>
                        <th scope="col">Distributors quantity</th>
                        <th scope="col">Retailers quantity</th>
                        <th scope="col">Current Processing Stage</th>
                    </tr>
                </thead>
                <tbody>
                    {Object.keys(MED).map(function (key) {
                        return (
                            <tr key={key}>
                                ...
                                <td>{MED[key].ManQuantity}</td>
                                <td>{MED[key].DisQuantity}</td>
                                <td>{MED[key].RetQuantity}</td>
                                <td>
                                    {
                                        MedStage[key]
                                    }
